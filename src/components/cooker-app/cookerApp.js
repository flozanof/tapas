...
class CookerApp extends React.Component {
    ...
    getActualPage() {
        const pages = [
            <CookerList activePageEvent={this.handleStatePageClick} loggedCookerId={this.state.loggedCookerId} />,
            <CookerCard activePageEvent={this.handleStatePageClick} cookerId={this.state.cookerId} loggedCookerId={this.state.loggedCookerId} />,
            <CookersTable activePageEvent={this.handleStatePageClick} allScore={true} loggedCookerId={this.state.loggedCookerId} />,
            <CookersVoterTable activePageEvent={this.handleStatePageClick} loggedCookerId={this.state.loggedCookerId} />,
            <CookersScoreForm activePageEvent={this.handleStatePageClick} cookerId={this.state.cookerId} loggedCookerId={this.state.loggedCookerId} />];
