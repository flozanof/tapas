...
const CookerScoreForm = (props) => {
    ...
    React.useEffect(() => {
        console.log('cookerScoreForm.js. state.cookerId: ' + scoreCooker.id);
...
//        alert('Json values: ' + JSON.stringify(values))
    }
    ...
    if (scoreCooker.name) {
        ...
        console.log("cookerScoreForm.js: " + scoreCooker.coursePhoto);
    return (
        <div>
            <Grid container spacing={1} padding="50px">
                ...
                <Grid item xs={12} sm={4} md={3} lg={3} xl={2}>
                    <CookerAvatar
                        avatarImage={scoreCooker.cookerPhoto}
                ...
                <Grid item xs={12} sm={12} md={3} lg={3} xl={2}>
                    <CookerAvatar
                        avatarImage={scoreCooker.coursePhoto}
